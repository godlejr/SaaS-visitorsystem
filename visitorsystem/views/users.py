...
from visitorsystem.forms import Pagination, UpdateForm, PasswordUpdateForm, ProfessionalUpdateForm
from visitorsystem.models import db, User, Photo, Magazine, Professional, Follow, PhotoScrap, Comment, MagazineScrap, \
    Business
